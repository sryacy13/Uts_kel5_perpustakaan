...
<div class="min-h-screen flex items-center justify-center bg-blue-50">
    <div
        class="bg-white border border-blue-100 rounded-xl p-8 w-full max-w-xl shadow-md 
               animate-fade-in"
    >
        ...
        <div class="space-y-4">
            ...
            <div class="bg-green-100/50 border border-green-200 rounded-lg p-4">
                ...
                <a href="{{ route('profile.edit') }}" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition">
                    Kelola Profil
                </a>
            </div>
        </div>
